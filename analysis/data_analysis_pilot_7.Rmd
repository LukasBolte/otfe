...
csv_file <- "data/all_apps_wide_2025-04-09.csv"
df <- read_csv(csv_file) 
df <- df %>% filter(participant.finished == 1)

# Define the folder name variable
folder_name <- "output_2025-04-09-pilot_7"
...
survey_columns <- c('survey_student_loans_with_likert', 'survey_student_loans_without_likert','survey_student_loans_with', 'survey_student_loans_without','survey_student_loans_likelihood','survey_wealth_tax_savings_likelihood','survey_wealth_tax_savings','survey_wealth_tax_savings_number', 'survey_repatriation', 'survey_repatriation_likelihood',
...
```{r}
 # Define the survey questions and their labels
  ...
  answer_choices <- list(
    "survey_student_loans_likelihood" = c("1" = "Much less likely", "2" = "Somewhat less likely", "3" = "Equally as likely", "4" = "Somewhat more likely", "5" = "Much more likely"),
    ...
    "survey_wealth_tax_savings_likelihood" = c("1" = "Much less likely", "2" = "Somewhat less likely", "3" = "Equally as likely", "4" = "Somewhat more likely", "5" = "Much more likely"),
    "survey_pandemic" = c("1" = "Definitely less willing", "2" = "Less willing", "3" = "No change", "4" = "More willing", "5" = "Definitely more willing"),
    "survey_wealth_tax_savings" = c("1" = "Save much less", "2" = "Save somewhat less", "3" = "No change", "4" = "Save somewhat more", "5" = "Save much more"),
...
df$adjusted_payoff <- round(pmax(0, df$participant.payoff - 0.76), 2)
...
# Save as CSV file
write_csv(df_selected, "pilot_7.csv", col_names = TRUE)
